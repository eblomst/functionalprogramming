...
var _user$project$Binary$intOf = function (bits) {
	var intOf_ = F2(
		function (bits, result) {
			intOf_:
			while (true) {
				var _p0 = bits;
				if (_p0.ctor === '[]') {
	...
	return A2(intOf_, bits, 0);
};
var _user$project$Binary$bitsOf = F2(
	function (number, size) {
		var bitsOf_ = F3(
			function (number, size, result) {
				bitsOf_:
				while (true) {
					var _p1 = size;
					if (_p1 === 0) {
						...
						var _v4 = number >> 1,
							_v5 = size - 1,
							_v6 = {ctor: '::', _0: number & 1, _1: result};
						number = _v4;
						size = _v5;
						result = _v6;
						continue bitsOf_;
...
var _user$project$Binary$reverse = function (list) {
	var reverse_ = F2(
...
var _user$project$Machine$CPU = F5(
	function (a, b, c, d, e) {
		return {a: a, b: b, sp: c, ip: d, f: e};
	});
var _user$project$Machine$Machine = F4(
	function (a, b, c, d) {
		return {cpu: a, memory: b, limit: c, running: d};
	});
var _user$project$Machine$machine = A4(
	_user$project$Machine$Machine,
	A5(_user$project$Machine$CPU, 0, 0, 0, 0, false),
	A2(
		_elm_lang$core$Array$initialize,
		64,
		function (i) {
			return {ctor: '_Tuple2', _0: i, _1: 0};
		}),
	0,
	false);
var _user$project$Machine$Instruction = F3(
	function (a, b, c) {
		return {code: a, name: b, operation: c};
	});
var _user$project$Machine$simpleInstruction = function (bits) {
	var halt_op = function (machine) {
		return _elm_lang$core$Native_Utils.update(
			machine,
			{running: false});
	};
	var nop_op = function (machine) {
		return machine;
	};
	var memomry_ = _user$project$Machine$machine.memory;
	var cpu_ = _user$project$Machine$machine.cpu;
	var add_op = function (machine) {
		return _elm_lang$core$Native_Utils.update(
			machine,
			{
				cpu: _elm_lang$core$Native_Utils.update(
					cpu_,
					{a: cpu_.a + cpu_.b})
			});
	};
	var mul_op = function (machine) {
		return _elm_lang$core$Native_Utils.update(
			machine,
			{
				cpu: _elm_lang$core$Native_Utils.update(
	...
	_v0_4:
	do {
		if (((((((_p0.ctor === '::') && (_p0._0 === 0)) && (_p0._1.ctor === '::')) && (_p0._1._0 === 0)) && (_p0._1._1.ctor === '::')) && (_p0._1._1._1.ctor === '::')) && (_p0._1._1._1._1.ctor === '[]')) {
			switch (_p0._1._1._0) {
				case 0:
					switch (_p0._1._1._1._0) {
						case 0:
							return A3(_user$project$Machine$Instruction, 0, 'NOP', nop_op);
						case 1:
							return A3(_user$project$Machine$Instruction, 1, 'ADD', add_op);
						default:
							break _v0_4;
					}
				case 1:
					switch (_p0._1._1._1._0) {
						case 0:
							return A3(_user$project$Machine$Instruction, 2, 'MUL', mul_op);
						case 1:
							return A3(_user$project$Machine$Instruction, 3, 'DIV', div_op);
						default:
							break _v0_4;
					}
				default:
	...
	return A3(_user$project$Machine$Instruction, 15, 'HALT', halt_op);
};
var _user$project$Machine$instruction = function (code) {
	var bits = A2(_user$project$Binary$bitsOf, code, 8);
	var _p1 = bits;
	if ((((((((_p1.ctor === '::') && (_p1._0 === 0)) && (_p1._1.ctor === '::')) && (_p1._1._0 === 0)) && (_p1._1._1.ctor === '::')) && (_p1._1._1._0 === 0)) && (_p1._1._1._1.ctor === '::')) && (_p1._1._1._1._0 === 0)) {
		return _user$project$Machine$simpleInstruction(bits);
	} else {
		return _user$project$Machine$simpleInstruction(bits);
	}
};

var _user$project$Styles$SPCell = {ctor: 'SPCell'};
var _user$project$Styles$IPCell = {ctor: 'IPCell'};
var _user$project$Styles$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'virtualcpu', _p0));
}(
	{
		ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				_user$project$Styles$IPCell,
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$backgroundColor(
						_rtfeldman$elm_css$Css$hex('FFCCCC')),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Main$memoryValue = function (machine) {
	var _p0 = A2(_elm_lang$core$Array$get, machine.cpu.ip, machine.memory);
	if (_p0.ctor === 'Just') {
		return A2(_user$project$Binary$bitsOf, _p0._0._1, 8);
	} else {
		return A2(_user$project$Binary$bitsOf, 0, 8);
	}
};
var _user$project$Main$executeAdvanced = F2(
	function (advancedInstruction, machine) {
		return machine;
	});
var _user$project$Main$executeSimple = F2(
	function (simpleInstruction, machine) {
		return machine;
	});
var _user$project$Main$executeNext = function (machine) {
	var instruction = _user$project$Main$memoryValue(machine);
	var _p1 = instruction;
	_v1_3:
	do {
		if ((((((_p1.ctor === '::') && (_p1._0 === 0)) && (_p1._1.ctor === '::')) && (_p1._1._0 === 0)) && (_p1._1._1.ctor === '::')) && (_p1._1._1._1.ctor === '::')) {
			switch (_p1._1._1._0) {
				case 0:
					switch (_p1._1._1._1._0) {
						case 0:
							return A2(_user$project$Main$executeSimple, _p1._1._1._1._1, machine);
						case 1:
							return A2(_user$project$Main$executeAdvanced, _p1._1._1._1._1, machine);
						default:
							break _v1_3;
					}
				case 1:
					if ((_p1._1._1._1._0 === 0) && (_p1._1._1._1._1.ctor === '::')) {
						return machine;
					} else {
						break _v1_3;
					}
...
var _user$project$Main$update = F2(
	function (message, model) {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				machine: _user$project$Main$executeNext(model.machine)
			});
	});
var _user$project$Main$_p3 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('virtualcpu');
...
var _user$project$Main$renderCell = F2(
	function (cpu, _p4) {
		var _p5 = _p4;
		var stringOf = function (bits) {
			var _p6 = bits;
			if (_p6.ctor === '[]') {
				return '';
			} else {
				if ((((_p6._1.ctor === '::') && (_p6._1._1.ctor === '::')) && (_p6._1._1._1.ctor === '::')) && (_p6._1._1._1._1.ctor === '[]')) {
					return A2(
						_elm_lang$core$Basics_ops['++'],
						' ',
						A2(
				...
				_0: A2(
					_elm_lang$html$Html$td,
					{
						...
						_0: _user$project$Main$class(
							{
								ctor: '::',
								_0: _user$project$Styles$SPCell,
								_1: {
									ctor: '::',
									_0: _user$project$Styles$IPCell,
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							stringOf(
								A2(_user$project$Binary$bitsOf, _p5._1, 8))),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
	...
	function (cpu, _p7) {
		...
		return A2(
			...
			_elm_lang$core$List$concat(
				{
					ctor: '::',
					_0: A2(_user$project$Main$renderCell, cpu, _p8._0),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main$renderCell, cpu, _p8._1),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$renderCell, cpu, _p8._2),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Main$renderCell, cpu, _p8._3),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Main$view = function (model) {
	var memory = model.machine.memory;
	var columns = A5(
		...
		_elm_lang$core$Array$toList(
			A3(_elm_lang$core$Array$slice, 0, 16, memory)),
		_elm_lang$core$Array$toList(
			A3(_elm_lang$core$Array$slice, 16, 32, memory)),
		_elm_lang$core$Array$toList(
			A3(_elm_lang$core$Array$slice, 32, 48, memory)),
		_elm_lang$core$Array$toList(
			A3(_elm_lang$core$Array$slice, 48, 64, memory)));
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'border', '1'),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'cellpadding', '2'),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'cellspacing', '10'),
							_1: {ctor: '[]'}
						}
					}
				},
				A2(
					_elm_lang$core$List$map,
					_user$project$Main$renderRow(model.machine.cpu),
					columns)),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$model = _user$project$Main$Model(_user$project$Machine$machine);
