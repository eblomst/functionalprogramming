...
(defun myFunction (f l) l
(if (equal l nil)

    nil
  (cons (funcall f(car l)) (myFunction f(cdr l)))
)
)
(write(myFunction (lambda (a) (+ a 5)) (list 1 5 3 9)))
